<?php
  ...
  while ($row = $result->fetch_assoc()) {
    ...
    // Считаем общее количество вхождений всех слов запроса в заголовок  //del this text<-
...
// Выполняем поиск ссылок
$results = search_links($query);

// Выводим результаты
foreach ($results as $result) {
  echo '<a href="' . $result['url'] . '">' . $result['url'] . '</a> (' . $result['count'] . ' вхождений)<br>';
}
?>
